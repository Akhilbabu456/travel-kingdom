  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-5 py-24 text-center lg:px-8">
        <Reveal>
          <div className="inline-flex rounded-full bg-primary/10 px-4 py-1.5 text-xs font-medium uppercase tracking-[0.18em] text-primary">
            In the atelier
          </div>
          <h2 className="mt-6 font-display text-3xl text-foreground sm:text-4xl">
            This chapter is being hand-crafted.
          </h2>
          <p className="mt-4 text-muted-foreground">
            Our designers are putting the final brushstrokes on this experience. In the meantime,
            speak to a specialist — they'll get you exactly what you need.
          </p>
