  ...
  return (
    <Link href="/" className="group flex items-center gap-2.5">
      ...
      <span className="flex flex-col leading-none">
        <span
          className={`font-display text-[1.15rem] font-semibold tracking-tight ${light ? "text-white" : "text-foreground"}`}
        >
          Travel<span className="gradient-text">Kingdom</span>
        </span>
        <span
          className={`mt-0.5 text-[0.62rem] uppercase tracking-[0.18em] ${light ? "text-white/70" : "text-muted-foreground"}`}
        >
