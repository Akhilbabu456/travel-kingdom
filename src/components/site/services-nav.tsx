...
const tabs = [
  {
    ...
    icon: (
      <svg className="w-12 h-12 max-sm:w-9 max-sm:h-9" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="23" y="30" width="6" height="4" rx="1" stroke="#F97316" strokeWidth="1.5" fill="none" />
        <circle cx="21" cy="48" r="1.5" fill="#4B5563" />
        <circle cx="31" cy="48" r="1.5" fill="#4B5563" />
        {/* Plane */}
        <path d="M42 22L46 16L48 17L46 22L50 25L52 24L53 26L49 28L47 32L45 32L46 28L42 26L38 27L38 25L42 22Z" fill="#3B82F6" />
        {/* Dotted path */}
        <path d="M30 40C38 40 46 36 46 28" stroke="#F59E0B" strokeWidth="1.5" strokeDasharray="3 3" fill="none" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-12 h-12 max-sm:w-9 max-sm:h-9" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Sky / Air trail */}
        <path d="M12 42C24 42 36 28 52 24" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeDasharray="4 4" />
        {/* Plane */}
  ...
  },
  {
    ...
    icon: (
      <svg className="w-12 h-12 max-sm:w-9 max-sm:h-9" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <polygon points="21,9 22.5,12.5 26,12.5 23,14.5 24.5,18 21,16 17.5,18 19,14.5 16,12.5 19.5,12.5" fill="#F59E0B" />
        <polygon points="43,9 44.5,12.5 48,12.5 45,14.5 46.5,18 43,16 39.5,18 41,14.5 38,12.5 41.5,12.5" fill="#F59E0B" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-12 h-12 max-sm:w-9 max-sm:h-9" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Passport Red Book */}
        <rect x="14" y="22" width="20" height="28" rx="2" fill="#B91C1C" transform="rotate(-5, 24, 36)" />
        <rect x="20" y="26" width="10" height="6" fill="#F59E0B" transform="rotate(-5, 24, 36)" />
        <circle cx="24" cy="38" r="4" stroke="#FEF08A" strokeWidth="1" fill="none" transform="rotate(-5, 24, 36)" />
  ...
  },
  {
    ...
    icon: (
      <svg className="w-12 h-12 max-sm:w-9 max-sm:h-9" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M26 26V38M23 29H29M23 35H29" stroke="#FEF08A" strokeWidth="2" strokeLinecap="round" />
        
        {/* Currency Coin 2 */}
        <circle cx="38" cy="38" r="12" fill="#F59E0B" />
        <circle cx="38" cy="38" r="10" stroke="#FEF08A" strokeWidth="1" fill="none" />
        <path d="M35 34C35 34 38 32 40 34C42 36 38 38 41 40" stroke="#FEF08A" strokeWidth="2" strokeLinecap="round" fill="none" />
        <path d="M38 32V42" stroke="#FEF08A" strokeWidth="1.5" />

        {/* Circular Arrows */}
        <path d="M22 20C28 14 38 15 44 21" stroke="#38BDF8" strokeWidth="2" strokeLinecap="round" fill="none" />
        <path d="M44 21L39 21M44 21L44 16" stroke="#38BDF8" strokeWidth="2" strokeLinecap="round" />

        <path d="M42 44C36 50 26 49 20 43" stroke="#38BDF8" strokeWidth="2" strokeLinecap="round" fill="none" />
      ...
      <div className="w-full max-w-4xl rounded-[2.5rem] bg-white border border-[#EBE7DF]/40 p-2 sm:p-3 shadow-[0_20px_50px_rgba(139,125,103,0.08)] backdrop-blur-md">
        <div className="flex items-center justify-between gap-1 sm:gap-4 overflow-x-auto no-scrollbar w-full px-2 sm:px-6">
          {tabs.map((tab) => {
            ...
            return (
              <Link key={tab.href} href={tab.href} className="group shrink-0 flex flex-col items-center py-2 px-1 sm:px-2 relative">
                <button
                  type="button"
                ...
                >
                  ...
                  <span className={`font-display text-xs font-bold tracking-wide sm:text-sm transition-colors duration-300 pb-2 ${
