    ...
    <section className="mx-auto max-w-7xl px-5 lg:px-8">
      ...
      >
        ...
        <div className="relative grid items-end gap-8 lg:grid-cols-2">
          <div>
            <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/15 px-3 py-1 text-[11px] uppercase tracking-[0.18em] text-white/80">
              Newsletter
            </div>
            <h2 className="font-display text-4xl leading-tight text-white sm:text-5xl">
              Wanderlust, every Friday.
            </h2>
            <p className="mt-3 max-w-md text-white/70">
              Hand-picked itineraries, secret openings and quiet seasonal deals. Zero spam — pinky
              promise.
            </p>
          </div>
