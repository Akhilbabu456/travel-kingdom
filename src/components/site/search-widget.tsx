...
export function SearchWidget({ floating = false }: { floating?: boolean }) {
  ...
  return (
    <div
      className={`w-full overflow-hidden rounded-3xl p-4 sm:p-5 shadow-2xl ${
        floating
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div
          className={`text-[10px] uppercase tracking-[0.12em] font-bold pb-0.5 ${floating ? "text-white/80" : "text-slate-500"}`}
        >
          {label}
        </div>
        <input
