            ...
            <div className="rounded-[2rem] border border-border bg-card p-6 sm:p-10 shadow-luxe">
              ...
              {sent ? (
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-6 py-4 text-sm font-semibold text-primary-foreground shadow-glow transition hover:opacity-90 active:scale-95"
                  >
