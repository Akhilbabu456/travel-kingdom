...
export default function CareersPage() {
  const [form, setForm] = useState({ name: "", email: "", phone: "", role: "Travel Designer", cover: "" });
  ...
  const openPositions = [
    {
      ...
      requirements: "2-4 years experience in travel sales or itinerary mapping. Excellent communication and destination knowledge.",
    },
    {
      ...
      requirements: "Deep understanding of document audits, financial checklist rules, and embassy portal configurations.",
    },
    {
      ...
      requirements: "Strong empathy, problem-solving, and coordination skills. Travel industry experience is a major plus.",
    },
  ];
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            <span className="text-xs font-semibold uppercase tracking-wider text-primary">Our Culture</span>
            <h2 className="font-display text-3xl sm:text-4xl text-foreground">
              We Craft Freedom, Not Just Ticketing.
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              At Travel Kingdom, we are not automated ticket bookers. We are advisors, writers, and designers. We believe in replacing travel anxiety with absolute, pure joy. Our team culture is centered on continuous learning, destination scouting, customer obsession, and mutual growth.
            </p>
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground max-w-xs mx-auto">
                  Thank you for applying! Our HR team will review your qualifications and reach out if there is a match.
                </p>
                <button
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-muted-foreground uppercase">Role of Interest</label>
                  <select
                    value={form.role}
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-muted-foreground uppercase">Cover Note / Experience</label>
                  <textarea
                    rows={3}
                    value={form.cover}
      ...
      <section className="bg-muted/40 py-20">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Openings</span>
            <h2 className="font-display text-3xl sm:text-4xl text-foreground">Current Open Positions</h2>
            <p className="text-muted-foreground">We are hiring across multiple disciplines in our Pune office.</p>
          </div>

          <div className="space-y-6 max-w-4xl mx-auto">
            {openPositions.map((pos) => (
              <div key={pos.title} className="rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-border pb-4 mb-4">
                  ...
                  <button
                    onClick={() => {
                      setForm((f) => ({ ...f, role: pos.title.includes("Visa") ? "Visa Operations Specialist" : pos.title.includes("Relationship") ? "Client Relationship Manager" : "Travel Designer" }));
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="text-xs font-semibold uppercase text-muted-foreground">Job Description</h4>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/85 mt-1 leading-relaxed">{pos.requirements}</p>
                  </div>
                </div>
              </div>
            ))}
